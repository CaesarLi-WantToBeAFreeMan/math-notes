...
1.
    $f(x) = \begin {cases} (x+1)^2, \quad x<-1\\ -x, \quad -1 \le x <1\\ \sqrt {x-1}, x \ge 1 \end {cases}$
    ...
    \begin {document}
        \begin {tikzpicture}
            ...
            \draw [->, line width=1.2pt, color=neon-pink] (0,-3) -- (0,3) node [above, color=bright-aqua, scale=1.5] {$y$};
            \node [below left, color=bright-aqua, scale=1.5] at (0,0) {$0$};
            \draw [dashed, line width=1.2pt, color=neon-red] (-1,-3) -- (-1,3) node [above left, color=neon-red, scale=1.5] {$x=-1$};
            \draw [dashed, line width=1.2pt, color=neon-red] (1,-3) -- (1,3) node [above left, color=neon-red, scale=1.5] {$x=1$};
